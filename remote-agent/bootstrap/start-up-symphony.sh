...
mage cluster:deployWithSettings "--set remoteAgent.used=true --set remoteAgent.remoteCert.trustCAs.secretName=<secret name> --set remoteAgent.remoteCert.trustCAs.secretKey=<secret key> --set installServiceExt=true"
# default is : mage cluster:deployWithSettings "--set remoteAgent.used=true --set remoteAgent.remoteCert.trustCAs.secretName=client-cert-secret --set remoteAgent.remoteCert.trustCAs.secretKey=client-cert-key --set installServiceExt=true"
